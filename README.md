...
1. After that, locate the `src/main/java/es/Es.java` file, right-click it, and choose `Run 'es.Es.main()'` (if the code editor is showing compile errors, try restarting the IDE). If the setup is correct, you should see something like the below as the output:
   ```
    _____
   | ____|___
   |  _| / __|
